...
import { Walkthrough } from "@/data/cybersecurity";
...
export function WalkthroughContent({ walkthrough }: WalkthroughContentProps) {
                ...
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    code: ({ inline, className, ...props }: { inline?: boolean; className?: string; children?: React.ReactNode }) => {
                      ...
                      if (codeLanguage === 'bash' || codeLanguage === 'sh' || codeLanguage === 'shell') {
                        textColor = 'text-cyan-200';
                      } else if (codeLanguage === 'http' || codeLanguage === 'plaintext') {
                        textColor = 'text-emerald-200';
                      } else if (codeLanguage === 'php' || codeLanguage === 'python' || codeLanguage === 'javascript') {
